...
/**
 * This class implements TestNG's ITestListener interface to generate an Extent
 * Report
...
public class ExtentReporter implements ITestListener {
    ...
    /*
     * to avoid overlapping of reports after every test executon. as we have to
    ...
    /**
     * Called when a test suite starts. Creates a test suite node in the Extent
     * Report.
     *
    ...
    /**
     * Called when a test method fails. Logs failure status and error message in the
     * report.
     *
     * @param result The test result object
     */
